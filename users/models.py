...
class Profile(models.Model):
    ...
    profile_picture = models.ImageField(upload_to='profile_pictures/', default='profile_pictures/default_profile_kd4hxj')
    background_picture = models.ImageField(upload_to='background_pictures/', default='background_pictures/default_background_fdipzl')
