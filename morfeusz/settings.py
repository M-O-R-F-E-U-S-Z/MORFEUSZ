"""
Django settings for morfeusz project.
...
WSGI_APPLICATION = 'morfeusz.wsgi.application'
...
MODEL_PATH = os.path.join(BASE_DIR, 'media/ML_MODEL/Model_{}nodes-{}conv-{}dense_ofpgfn.hp5'.format(128, 4, 2))
